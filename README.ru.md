...
[О проекте](#-о-проекте) • [Возможности](#-возможности) • [Архитектура](#-архитектура-workspace) • [Сборка](#-сборка-из-исходников) • [Дорожная карта](#-дорожная-карта) • [Концепция и план 1.0](docs/CONCEPT.ru.md)
...
## 💻 Целевые системные требования

AMC Launcher спроектирован с упором на максимальную производительность, мгновенный отклик, стабильные 60+ FPS интерфейса и минимальную нагрузку на систему даже на ультрабюджетных или устаревших ПК:

- **GPU:** NVIDIA GeForce GT 710 (1 ГБ DDR3, 64-bit, пропускная способность VRAM ~14.4 ГБ/с, шейдерная модель 5.0, DX11 FL 11_0) или аналог с поддержкой OpenGL 3.3+
- **CPU:** 2 ядра / 4 потока, ~3.0 ГГц (уровень Intel Core i3-2100), без необходимости в инструкциях AVX2
- **RAM:** 4 ГБ DDR3-1333
- **Потребление ресурсов:** ~35 МБ ОЗУ в простое, размер исполняемого файла ~25 МБ, холодный старт за <300 мс
...
> Концепция продукта: [docs/CONCEPT.ru.md](docs/CONCEPT.ru.md).
> Полный план v1.0 (фазы P0–P13, аудит, DoD): [docs/ROADMAP-1.0.ru.md](docs/ROADMAP-1.0.ru.md).
